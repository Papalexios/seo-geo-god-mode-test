...
useEffect(() => { localStorage.setItem('excludedUrls', JSON.stringify(excludedUrls)); }, [excludedUrls]);                                           ', JSON.stringify(excludedUrls)); }, [excludedUrls]);
  useEffect(() => { localStorage.setItem('prioritizedUrlsForGodMode', JSON.stringify(prioritizedUrlsForGodMode)); }, [prioritizedUrlsForGodMode]);    useEffect(() => { localStorage.setItem('excludedCategories', JSON.stringify(excludedCategories)); }, [excludedCategories]);
